document.addEventListener("DOMContentLoaded", function() {
    ...
    let grado = params.get("grado") || "primergrado";
    ...
    const alumnosPorGrado = {
        "primergrado": [
    "Luis Fernando Campos Ortiz",
    "Mateo Antonio Rivas Cabrera"
  ],

  "segundogrado": [
    "Santiago Eduardo Amaya Delgado",
    "Carlos Alberto Blanco Ramos",
    "Daniel Ernesto Guevara Pérez",
    "Andrea Sofía Mendoza Castillo",
    "Camila Fernanda Ortiz Flores",
    "Lucía Daniela Ramírez López"
  ],

  "tercergrado": [
    "Sebastián Adrián Aguilar Gómez",
    "Gabriel Alejandro Chávez Escobar",
    "Marcos Elías Díaz García",
    "Isabella Victoria Fuentes Hernández",
    "Valentina Sofía López Morales",
    "Sofía Carolina Morales Herrera",
    "Emilia Patricia Torres Rivas"
  ]
    };
    ...
    function formatoGrado(gradoStr){
        switch(gradoStr){
            case "primergrado": return "Primer Grado";
            case "segundogrado": return "Segundo Grado";
            case "tercergrado": return "Tercer Grado";
    ...
    window.guardarTodasNotas = function(){
        guardarEnLocalStorage(); 
        mostrarMensaje('Todas las notas se guardaron correctamente.','success');
    };

    window.actualizarNotas = function(){
        document.querySelectorAll('.grade-input').forEach(input=>calcularPromedio(input));
    };
