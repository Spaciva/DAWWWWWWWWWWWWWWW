document.addEventListener("DOMContentLoaded", function() {
    ...
    let grado = params.get("grado") || "parvularia4";
    ...
    const alumnosPorGrado = {
       "parvularia4": [
    "José Miguel Avilés López",
    "Pablo Andrés Benítez Ramos",
    "Rodrigo Daniel Carranza Cruz",
    "Adriana Sofía Pérez Romero",
    "Laura Beatriz León Torres"
  ],
  
  "parvularia5": [
    "Kevin Alexander Flores Mejía",
    "Fátima Isabel Ramos Molina",
    "Alma Carolina Santos López",
    "Valeria Estefanía Sandoval Díaz"
  ],
  
  "parvularia6": [
    "Roberto Carlos González Rivera",
    "Emerson Josué Peña Martínez",
    "Victoria Alejandra Tobar Hernández"
  ]
    };
    ...
    function formatoGrado(gradoStr){
        switch(gradoStr){
            case "parvularia4": return "Parvularia 4 años";
            case "parvularia5": return "Parvularia 5 años";
            case "parvularia6": return "Parvularia 6 años";
